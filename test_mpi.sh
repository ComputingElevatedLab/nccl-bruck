...
echo ------NCCL MPI ModInverse Bruck Test------
mpiexec -n $RANKS -ppn 4 ./build/mpibruck_perf -a 3 -d int8 -c 0 -b $MIN_BYTES -e $MAX_BYTES -f 2 -g 1 -n 500 -w 100

echo ------NCCL MPI ModInverse Bruck Test------
mpiexec -n $RANKS -ppn 4 ./build/mpispreadout_perf -a 3 -d int8 -c 0 -b $MIN_BYTES -e $MAX_BYTES -f 2 -g 1 -n 500 -w 100
